...
for index in range(0, len(countries)-1):
    print(percent[index])
    print(int(percent[index]))
    print(round(percent[index], 2))

for index in range(0, len(countries) - 1):
    print("Country: \t", countries[index], "Points: \t", int(percent[index] * sumOfPoints/100))
